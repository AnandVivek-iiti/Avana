...
import { CLUB_HEAD, CO_HEADS, HEADS, LEADS, MEMBERS } from "../data/team";
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 50% -10%, rgba(245,200,66,0.12) 0%, transparent 65%)",
        }}
      />
      ...
      <div className="relative inline-flex mb-5">
        <div
          ...
          style={{
            boxShadow: "0 0 0 3px #f5c842, 0 0 0 6px rgba(245,200,66,0.2)",
          }}
        >
          <Avatar m={m} size="xl" />
        </div>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg,rgba(245,200,66,0.2),rgba(232,113,10,0.15))",
          color: "#e8710a",
      ...
      {m.quote && (
        <p
          className="text-xs italic mb-4 mt-3 leading-relaxed px-2"
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 50% -10%, rgba(232,113,10,0.1) 0%, transparent 65%)",
        }}
      />
      ...
      <div className="flex justify-center mb-4">
        <div
          ...
          style={{
            boxShadow: "0 0 0 2px #e8710a, 0 0 0 4px rgba(232,113,10,0.15)",
          }}
        >
          <Avatar m={m} size="lg" />
        </div>
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 50% 0%, rgba(26,92,46,0.08) 0%, transparent 65%)",
        }}
      />
      ...
      <p className="text-[11px] mb-0.5" style={{ color: "var(--green-mid)" }}>
        {m.role}
      </p>
      {m.dept && (
...
function MemberInsights() {
  const withExp = [...CO_HEADS, ...HEADS, ...LEADS, ...MEMBERS].filter(
    (m) => m.experience,
  );
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {withExp.map((m, i) => (
          <motion.div
            ...
            style={{
              borderColor: expanded === i ? "var(--border-strong)" : undefined,
            }}
          ...
          >
              ...
              {expanded === i && (
                ...
                >
                  ...
                  >
                    <Quote
                      size={12}
                      className="inline mr-1.5 mb-0.5 opacity-50"
            ...
            {expanded !== i && (
              <p
                className="mt-3 text-[10px] leading-relaxed line-clamp-2 italic"
                style={{ color: "var(--text-secondary)" }}
              >
                {m.experience}
              </p>
    ...
    <div className="pt-24 pb-24 px-6 min-h-screen">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h1
            className="text-5xl md:text-7xl font-black mt-4 mb-4"
            style={{ color: "var(--text-primary)" }}
          >
          ...
          <p
            ...
            style={{ color: "var(--text-secondary)" }}
          >
            Meet the changemakers driving AVANA's mission — from leadership to
            members, every role matters.
          </p>
        </motion.div>
        ...
        <div className="flex justify-center mb-0">
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom,rgba(245,200,66,0.5),rgba(232,113,10,0.3))",
            }}
          />
        </div>
        <div
          ...
          style={{
            background:
              "linear-gradient(to right,transparent,rgba(232,113,10,0.3),transparent)",
          }}
        />
        <div className="flex justify-center">
          <div
            className="w-1/3 h-px"
            style={{ background: "rgba(232,113,10,0.2)" }}
          />
        </div>
        <div className="flex justify-center gap-[33.3%] mb-0">
          <div
            className="w-px h-6"
            style={{ background: "rgba(232,113,10,0.3)" }}
          />
          <div
            className="w-px h-6"
            style={{ background: "rgba(232,113,10,0.3)" }}
