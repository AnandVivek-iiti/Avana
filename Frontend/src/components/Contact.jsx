...
// <br />
//         {/* Map */}
//         <div className="rounded-2xl overflow-hidden border border-white/10 shadow-lg h-[300px] md:h-auto w-full">
//           <iframe
//             title="IITI Location"
//             width="100%"
//             height="100%"
...
//         </div>
//         {/* Team Cards */}
//         <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-6 w-240">
